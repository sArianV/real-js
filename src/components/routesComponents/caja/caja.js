...
class Caja extends Component {
    ...
    render() {
        ...
        return (
            <div className={Style.cajaBody}>
                <div className={Style.listItems}>aca va el componente de la lista de compras </div>
                <div className={Style.in}>
                    <div className={Style.imputBox}> componente donde se eligen los items
                        <Autocomplete
                            id="grouped-products"
                    ...
                    <div className={Style.checkOutBox}> componente del total y el medio de pago</div>
                </div>
            </div>
